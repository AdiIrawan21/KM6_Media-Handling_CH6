...
const { storageImageSingle, storageImageMultiple, storageVideoSingle, storageVideoMultiple, storageFileSingle, storageFileMultiple } = require('../controllers/media.controllers');
